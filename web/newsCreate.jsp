...
<html>
    ...
    <body>
        ...
        <main>
            <form method="POST" action="/OJT_Mock/news-manage?action=register" id="form" class="container" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id="shortDescription" aria-describedby="shortDes" placeholder="Enter Short Description" style="height: 80px; min-height: 36px" name="shortDes" required></textarea>
                    <div class="char-count"><span id="charCountShort">0</span>/200</div>
                </div>
                <div class="form-group">
                    <label for="detailDescription">Detail Description</label>
                    <textarea type="text" class="form-control" id="detailDescription" aria-describedby="detailDescription" maxlength="4000" placeholder="Enter Detail Description" style="height: 30em; min-height: 36px" name="newsDes" required></textarea>
