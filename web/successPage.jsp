<%-- 
    ...
    Created on : Mar 11, 2023, 6:05:09 PM
    Author     : toten
--%>
        ...
        <div class="wrapperAlert">
            ...
            <div class="contentAlert">
                ...
                <div class="bottomHalf">
                    ...
                    <p>Well Done! Thank you for being a part of this society</p>

                    <a type="button" href="${sessionScope.urlHistory != null ? sessionScope.urlHistory : 'home'}" id="alertMO">Go Back</a>
